...
def main(tn:str='slaving_single_stage',
    ...
    opt_gains = ssao.calibrate_optical_gains(timeInSeconds=0.0, slope_computer=ssao.sc, MM=KL, amps=0.02)
    plt.figure()
